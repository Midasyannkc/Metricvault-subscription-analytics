    ...
    create  table
      "metricvault"."main_marts"."fct_finance_reconciliation__dbt_tmp"
...
--
-- Source for finance_ledger: "metricvault"."raw_finance"."monthly_revenue_ledger"
...
finance_ledger as (
    ...
    from "metricvault"."raw_finance"."monthly_revenue_ledger"
)
